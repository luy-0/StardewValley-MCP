...
class CommandRequest(_message.Message):
    __slots__ = ("command_id", "timeout_ms", "say", "emote", "face", "navigate", "interact", "use_tool", "equip", "open_menu", "activate_ui", "close_menu", "transfer_inventory_item", "set_equipment_slot", "query_runtime", "query_world", "query_inventory", "query_ui", "inspect")
