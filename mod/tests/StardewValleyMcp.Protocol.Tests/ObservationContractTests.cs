...
public sealed class ObservationContractTests
{
    ...
    public void GeneratedCatalogContainsAllPublicDescriptors()
    {
        ...
        {
            "say", "emote", "face", "navigate", "interact", "use_tool", "equip", "transfer_inventory_item", "set_equipment_slot", "move_inventory_item", "craft_item", "open_menu", "activate_ui", "close_menu",
            "query_runtime", "query_world", "query_inventory", "query_ui", "inspect",
        });
        Assert.That(snapshot.Capabilities, Has.Count.EqualTo(19));
